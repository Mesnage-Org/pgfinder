...
const PeptidoglycanFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_peptidoglycan_free(ptr >>> 0));
/**
*/
export class Peptidoglycan {
    ...
    */
    constructor(structure) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(structure, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
