...
<div class="mx-4 my-4" data-testid="deconvolutedData">
  ...
  <p class="text-xs">
    Ankur V Patel, Robert D Turner, Aline Rifflet, Adelina E Acosta-Martin,
    Andrew Nichols, Milena M Awad, Dena Lyras, Ivo Gomperts Boneca, Marshall
    Bern, Mark O Collins, Stéphane Mesnage (2021)
    <strong>
      PGFinder, a novel analysis pipeline for the consistent, reproducible, and
      high-resolution structural analysis of bacterial peptidoglycans
    </strong>
