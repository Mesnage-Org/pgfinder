<script lang="ts">
  ...
  $: SmithereensReady =
    ...
    smithereens.fragmentsData !== undefined &&
  ...
  $: PGFinderReady =
    !loading &&
    !processingPGFinder &&
    pyio.msData !== undefined &&
    pyio.massLibrary !== undefined;
...
<AppShell>
  ...
  <div class="h-full flex flex-cols-2 justify-center items-center">
    ...
    <div
      ...
      data-testid="Smithereens"
    >
      <section class="flex flex-col space-y-4 justify-center p-4">
        <FragmentsDataUploader
          bind:value={smithereens.fragmentsData}
    ...
    >
      <section class="flex flex-col space-y-4 justify-center p-4">
        ...
        <button
          type="button"
          class="btn variant-filled"
          on:click={runPGFinderAnalysis}
          disabled={!PGFinderReady}
        >
          Run Analysis
        </button>
