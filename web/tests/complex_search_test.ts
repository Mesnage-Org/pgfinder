...
test("run a complex search", async ({ page }) => {
  ...
  await page
    ...
    .getByRole("button", { name: "Escherichia coli" })
    .click();
  await page
    .getByTestId("MassLibraryUploader")
    .getByRole("option", { name: "Complex" })
    .click();

  await page.getByRole("button", { name: "Advanced Options" }).click();
  await page
    .getByTestId("modificationSelector")
  ...
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", { name: "Deacetylation (-Ac)" })
    .click();
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", {
  ...
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", { name: "Amidation (Am)" })
    .click();
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", { name: "O-Acetylation (+Ac)" })
    .click();
  await page
    .getByTestId("modificationSelector")
  ...
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", { name: "Sodium Adduct (Na+)" })
    .click();
  await page
    .getByTestId("modificationSelector")
  ...
  await page
    .getByTestId("modificationSelector")
    .getByRole("option", { name: "Loss of GlcNAc (-g)" })
    .click();
  ...
  await page
    .getByTestId("advancedModifications")
